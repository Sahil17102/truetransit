...
const TrueTransitLanding = lazy(() => import('../pages/marketing/TrueTransitLanding'))
...
const ROUTE_RELOAD_KEY = 'truetransit-route-asset-reload'
    ...
    <>
      ...
      <RouteErrorBoundary resetKey={routeKey}>
        <Suspense fallback={<FullScreenLoader />}>
          ...
          <Route path="/integrations" element={<TrueTransitLanding />} />
          <Route path="/integrations/sales-channels" element={<TrueTransitLanding />} />
          <Route path="/integrations/courier-partners" element={<TrueTransitLanding />} />
          <Route path="/blogs" element={<TrueTransitLanding />} />
          <Route path="/about" element={<TrueTransitLanding />} />
          <Route path="/careers" element={<Navigate to="/about" replace />} />
          <Route path="/contact" element={<TrueTransitLanding />} />
          ...
          <Route path="/tracking" element={<TrueTransitLanding />} />
          ...
          <Route path="/rate-calculator" element={<TrueTransitLanding />} />
          <Route path="/weight-calculator" element={<TrueTransitLanding />} />
