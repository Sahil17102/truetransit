...
export const TERMS_OPERATOR_LINE = 'These terms are issued by TrueTransit for use of the TrueTransit platform.'
...
Platform Use
- TrueTransit provides tools for shipment booking, rate calculation, label generation, courier allocation, tracking, wallet management, COD visibility, NDR/RTO workflows, reports, and related support.
...
- Invoices and statements must be reviewed promptly. Any billing concern should be raised with supporting details within the timeline communicated by TrueTransit.
...
- TrueTransit may hold, cancel, reject, or report shipments if the parcel or declaration appears suspicious, unsafe, restricted, unlawful, or non-compliant.
...
- You can request correction, access, or deletion of eligible personal information by contacting Hello@truetransitmobility.com or +91 7416582587, subject to legal, accounting, courier, fraud-prevention, and dispute-retention requirements.
...
- TrueTransit is not liable for indirect, incidental, special, consequential, or loss-of-profit damages arising from platform use, courier delays, failed pickups, delivery exceptions, third-party outages, or inaccurate information submitted by you.
...
- You may stop using the platform or request account closure by contacting Hello@truetransitmobility.com or +91 7416582587.
...
Contact and Grievance
- For terms, privacy, billing, shipment, refund, or grievance questions, contact TrueTransit at Hello@truetransitmobility.com or +91 7416582587.
`
