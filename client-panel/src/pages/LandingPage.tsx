...
const testimonials = [
  {
    quote:
      'TrueTransit cut our shipping costs by 30% and brought all our courier partners under one roof. The dashboard is a game changer.',
    initial: 'P',
    name: 'Priya Sharma',
  ...
  {
    quote:
      'The smart routing feature alone saved us lakhs. TrueTransit picks the fastest, cheapest courier for every order automatically.',
    initial: 'A',
    name: 'Ananya Desai',
...
const faqs = [
  {
    question: 'What services does TrueTransit provide?',
    answer:
      'TrueTransit provides comprehensive courier & logistics services including B2B and B2C shipping solutions, express delivery, warehousing, distribution, cargo transportation, and reverse logistics. We offer domestic and international shipping services tailored to meet your business needs.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Our customer support team is available 24/7 to assist you. You can reach us at +91 7416582587, email us at Hello@truetransitmobility.com, or chat with us on WhatsApp. Our office hours are 9:00 AM to 6:00 PM, Monday to Friday.',
  },
  {
