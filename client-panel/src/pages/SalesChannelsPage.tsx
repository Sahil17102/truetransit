...
const benefits = [
  {
    ...
    description:
      "New orders flow into your TrueTransit dashboard the moment they're placed &mdash; zero manual work.",
    icon: <FiRefreshCw />,
  },
  {
...
const steps = [
  ...
  },
  {
    ...
    description: 'Securely authorize TrueTransit to sync your orders and inventory.',
  },
  {
