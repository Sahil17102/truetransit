...
const CompanyDetails = () => {
  ...
  return (
    <Stack mt={2} gap={5}>
      <PageHeading
        title="Contact Us"
        subtitle="We’re here to help with bookings, account support, and courier operations. Reach out to TrueTransit whenever you need assistance."
      />
