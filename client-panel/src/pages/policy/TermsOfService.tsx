  ...
  return (
    <Box sx={{ maxWidth: 980, mx: 'auto', px: { xs: 1, sm: 2 }, py: 2 }}>
      <PageHeading
        ...
        subtitle="Clear operating terms for TrueTransit account access, shipping, billing, COD, restricted goods, refunds, and privacy."
        eyebrow="Legal"
      />
      ...
      <Typography sx={{ mt: 3, color: '#607397', lineHeight: 1.75 }}>
        ...
        features, or sharing customer shipment data through TrueTransit.{' '}
