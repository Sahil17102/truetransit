    ...
    <Container maxWidth="lg" sx={{ py: 8 }}>
      <Box display={'flex'} justifyContent={'center'}>
        <PageHeading
          ...
          subtitle="All policies, terms, and privacy information for TrueTransit"
        />{' '}
      </Box>
      ...
      <Box sx={{ mt: 6 }}>
        ...
        <Typography paragraph>
          • TrueTransit (TrueTransit) reserves the right to modify, suspend, or terminate
          the Service for any reason, without prior notice at any time.
        </Typography>
        <Typography paragraph>
          • Fraud Prevention: Without limiting any other remedies, TrueTransit may suspend or
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography paragraph>
          TrueTransit (TrueTransit) ("we," "our," or "us") operates the services offered
