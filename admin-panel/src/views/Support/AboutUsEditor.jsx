...
const AboutUsEditor = () => {
  ...
  const handleLoadTemplate = () => {
    const templateHtml = `
      <h2>About TrueTransit</h2>
      <p><strong>TrueTransit</strong> is a modern shipping operations platform built for ecommerce sellers who want faster dispatch, lower courier costs, and a smoother post-purchase experience.</p>
      ...
      <h3>Contact</h3>
      <p><strong>Email:</strong> Hello@truetransitmobility.com</p>
      <p><strong>Website:</strong> truetransitadmin.onrender.com</p>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updatePageMutation.mutateAsync({ title: 'About Us - TrueTransit', content })
      toast({
          ...
          <Box>
            ...
            <HStack spacing={3} mt={1}>
              <Text fontSize="sm" color="gray.500">
                Manage the TrueTransit story shown on the customer support screen.
              </Text>
              {page?.updated_at && (
