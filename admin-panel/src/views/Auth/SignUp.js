        ...
        >
          <VStack align="flex-start" spacing={5} position="relative" zIndex="1">
            ...
            <Text color={textSecondary} fontSize="sm" maxW="360px" lineHeight="1.8">
              Create a TrueTransit workspace for teams that need cleaner shipment
            ...
            <VStack spacing={6} align="stretch">
              <Box>
                ...
                <Text mt={2} color={textSecondary} fontSize="sm" lineHeight="1.8">
                  Use this setup form to onboard your TrueTransit operations team.
                </Text>
              </Box>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                ...
                <FormControl isRequired>
                  ...
                  <Input
                    placeholder="TrueTransit operations"
                    h="52px"
                    borderRadius="10px"
                    bg={inputBg}
                    borderColor={inputBorder}
